(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[50],{"40dz":function(e,t,o){"use strict"
o.r(t)
o.d(t,"default",(function(){return T}))
var c=o("An8g")
var l=o("VTBJ")
var a=o("HGxv")
var i=o("8WeW")
...
e.isToggleable?this.state.mode=e.isLocked?R.ADMIN_LOCKED:R.ADMIN_UNLOCKED:this.state.mode=e.isLocked?R.TEACH_LOCKED:R.TEACH_UNLOCKED}componentDidMount(){const e=Math.max(...Object.values(R).map(e=>e.label.length))
...
_=Object(c["a"])(B["a"],{tip:r,placement:"top",variant:"inverse",on:["hover","focus"]},void 0,this.props.breakpoints.miniTablet?Object(c["a"])(q["a"],{id:"lock-toggle-btn",elementRef:e=>this.toggleBtnRef=e,variant:n,onClick:this.props.onClick,onFocus:this.onEnter,onBlur:this.onExit,onMouseEnter:this.onEnter,onMouseLeave:this.onExit,"aria-pressed":this.props.isLocked},void 0,e||(e=Object(c["a"])(a,{})),t||(t=Object(c["a"])(j["a"],{},void 0,i)),o||(o=Object(c["a"])(E["a"],{},void 0,s))):Object(c["a"])(O["a"],{color:"primary"===n?n:null,onClick:this.props.onClick,onFocus:this.onEnter,onBlur:this.onExit,onMouseEnter:this.onEnter,onMouseLeave:this.onExit,"aria-pressed":this.props.isLocked,screenReaderLabel:s},void 0,l||(l=Object(c["a"])(a,{}))))}else _=Object(c["a"])("span",{className:"bpc__lock-no__toggle"},void 0,Object(c["a"])("span",{className:"bpc__lock-no__toggle-icon"},void 0,Object(c["a"])(a,{})),Object(c["a"])(L["a"],{size:"small"},void 0,i))
return Object(c["a"])("span",{className:"bpc-lock-toggle"},void 0,_)}}M.defaultProps={isToggleable:false,onClick:()=>{},breakpoints:{}}
const y=Object(I["a"])(M)
y.setupRootNode=M.setupRootNode
var D=y
class T{constructor(){this.toggleLocked=()=>{const e=this.props.itemType
...
this.setupToggle(()=>{u.a.render(Object(c["a"])(D,{isLocked:this.state.isLocked,isToggleable:"show"===this.props.page&&this.state.isMasterContent,onClick:this.toggleLocked}),this.toggleNode)})}renderBanner(){this.bannerNode||(this.bannerNode=C.setupRootNode())
...
this.renderLockToggle()}}},L2KU:function(e,t,o){"use strict"
...
while(l){t[l[2]]=l[1]
l=c.exec(o)}return t}
t["a"]=l},kC3k:function(e,t,o){"use strict"
...
u.variant="Solid"
u.propTypes=Object(c["a"])({},s["a"].propTypes)},poaC:function(e,t,o){"use strict"
var c=o("BrAc")
var l=o("L2KU")
var a=o("rf2n")
...
t["a"]=i},rf2n:function(e,t,o){"use strict"
...
t["a"]=i},tlDv:function(e,t,o){"use strict"
var c=o("17x9")
var l=o.n(c)
var a=o("rf2n")
...
u.itemLocksByObject=i({assignment:u.itemLocks,discussion_topic:u.itemLocks,wiki_page:u.itemLocks,quiz:u.itemLocks,attachment:u.itemLocks})},wOvH:function(e,t,o){"use strict"
...
case 1:return t[0]
default:return`${t.slice(0,-1).join(", ")} & ${t.slice(-1)[0]}`}}function n(e){const t=Object.keys(e).filter(t=>e[t])
return _(t)}}}])

//# sourceMappingURL=50-c-e238312e1f.js.map