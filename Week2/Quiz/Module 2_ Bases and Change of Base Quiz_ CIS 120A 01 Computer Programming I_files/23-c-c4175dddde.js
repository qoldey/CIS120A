...
a()(this.editor.getBody()).attr("aria-label",a()(`label[for="${this.id_prepend}"]`).text())
...
e.attr("tabindex",-1)}}},Ce78J:function(e,t,r){"use strict"
var o=r("Vc0b")
var i=r("eodz")
function n(e,t,r,o){const i=!r
const n=i?t:"function"===typeof o?o:t[r]
false
return n}var s=r("ouhR")
var a=r.n(s)
const c=!ENV.use_rce_enhancements&&r("UK4Q").default
function l(e,t,r){e.css("display","none")
const n=t.onFocus
t.onFocus=(...e)=>{ENV.use_rce_enhancements||g.showSidebar()
n instanceof Function&&n(...e)}
o["a"].loadOnTarget(e,t,(t,o)=>{const n=k(e)
const s=b(a()(t))
s.data("remoteEditor",o)
n.trigger(i["a"],o)
r&&r(o)})}function d(e){const t=k(e)
const r=t.attr("id")
const o="tinymce-parent-of-"+r
if(t.parent().attr("id")!==o)return t.wrap(`<div id='${o}' style='visibility: hidden'></div>`)}function _(){a()(".mce-resizehandle").attr("aria-hidden",true)}let u=0
function f(){return"random_editor_id_"+u++}function h(e){const t=a()(e)
const r="attr"in t?t.attr("id"):t.id
r&&""!=r||t.attr("id",f())}function b(e){const t=k(e)
const r=t.attr("id")
if(!r||""==r)return t
const o=a()("#"+r)
if(o.length<=0)return t
return o}const p="with the new RCE you don't need to call this method, it is a no op since there is no sidebar"
const g={preloadRemoteModule:(e=(()=>{}))=>o["a"].preload(e),initSidebar:n(p,(e={})=>{ENV.use_rce_enhancements||c.init(e)}),showSidebar:n(p,()=>{ENV.use_rce_enhancements||c.show()}),hideSidebar:n(p,()=>{ENV.use_rce_enhancements||c.hide()}),loadNewEditor(e,t={},r){let o=k(e)
if(o.length<=0)return
h(o)
t=a.a.extend({},t)
const i=e=>{t.focus&&this.activateRCE(o)
r&&r(e)}
o=this.freshNode(o)
if(t.manageParent){delete t.manageParent
d(o)}l(o,t,i)
_()},callOnRCE(e,t,...r){let o=k(e)
o=this.freshNode(o)
return Object(i["d"])(o,t,...r)},destroyRCE(e){let t=k(e)
t=this.freshNode(t)
Object(i["b"])(t)
ENV.use_rce_enhancements||c.hide()},closeRCE(e){window.ENV.use_rce_enhancements&&this.callOnRCE(e,"RCEClosed")},activateRCE(e){let t=k(e)
t=this.freshNode(t)
Object(i["c"])(t)
ENV.use_rce_enhancements||c.show()},freshNode:b,ensureID:h,node2jquery:k}
function k(e){return e&&e.length?e:a()(e)}t["a"]=g},UK4Q:function(e,t,r){"use strict"
r.r(t)
var o=r("ouhR")
var i=r.n(o)
var n=r("Vc0b")
function s(e){n["a"].loadSidebarOnTarget(i()("#editor_tabs").get(0),e)}const a={instance:void 0,pendingShow:false,initializing:false,subscriptions:{},init(e={}){if(!this.instance&&!this.initializing){this.initializing=true
...
this.subscriptions={}}}
t["default"]=a},Vc0b:function(e,t,r){"use strict"
var o=r("VTBJ")
var i=r("ouhR")
var n=r.n(i)
var s=r("Y/W1")
...
var c=r("JiFB")
var l=r("ik22")
function d(e,t,r){const i=Object(o["a"])({},r)
e.forEach(e=>{const o=t[e]
const n=r[e]
Array.isArray(o)&&Array.isArray(n)&&(i[e]=[...new Set(o.concat(n))])})
return i}function _(e,t,i,n,s){const a=new c["a"](s,l["a"],e,t)
const _=Object(o["a"])(Object(o["a"])({},a.defaultConfig()),{},{setup:e=>{ENV.use_rce_enhancements||e.on("init",()=>{const t=e=>e.default?e.default:e
const o=t(r("BdLV"))
new o(e).accessiblize()})}})
return Object(o["a"])(Object(o["a"])({},_),d(i.optionsToMerge||[],_,i.tinyOptions))}var u=_
var f=r("FNQM")
const h={call(e,...t){if("exists?"===e)return true
return this[e](...t)},focus(){if(void 0!==tinymce){const e=tinymce.get(this.getTextarea().id)
e&&e.focus(true)}}}
const b={show(){$("#editor_tabs").show()},hide(){$("#editor_tabs").hide()}}
const p={wrapEditor(e){const t=Object(o["a"])(Object(o["a"])({},h),e)
return Object.assign(e,t)},wrapSidebar(e){const t=Object(o["a"])(Object(o["a"])({},b),e)
return Object.assign(e,t)}}
var g=p
var k=r("eVns")
var m=r("stQK")
let y
const v={preload(e){(window.requestIdleCallback||window.setTimeout)(()=>this.loadRCE(e))},loadOnTarget(e,t,r){const o=this.getTargetTextarea(e)
const i=this.getRenderingTarget(o,t.getRenderingTarget)
const n=this.createRCEProps(o,t)
this.loadRCE(e=>{e.renderIntoDiv(i,n,e=>{e.tinymceOn?e.tinymceOn("init",()=>r(o,g.wrapEditor(e))):e.mceInstance().on("init",()=>r(o,g.wrapEditor(e)))})})},loadSidebarOnTarget(e,t){if(ENV.RICH_CONTENT_SKIP_SIDEBAR)return
const r=Object(k["a"])()
this.loadRCE(o=>{o.renderSidebarIntoDiv(e,r,e=>{t(g.wrapSidebar(e))})})},loadingCallbacks:[],RCE:null,loadRCE(e=(()=>{})){y||(y=(window.ENV.use_rce_enhancements?Promise.all([r.e(1),r.e(3),r.e(4),r.e(5),r.e(6),r.e(9),r.e(10),r.e(12),r.e(19),r.e(20),r.e(36),r.e(70),r.e(84),r.e(95),r.e(3676)]).then(r.bind(null,"j/Fk")):Promise.all([r.e(1),r.e(3),r.e(4),r.e(5),r.e(10),r.e(11),r.e(12),r.e(19),r.e(22),r.e(27),r.e(36),r.e(37),r.e(65),r.e(72),r.e(84),r.e(130),r.e(3677)]).then(r.bind(null,"dHiD"))).then(e=>{this.RCE=e
Object(f["a"])()
return e}))
return y.then(()=>{this.loadingCallbacks.forEach(e=>e(this.RCE))
this.loadingCallbacks=[]
e(this.RCE)})},getTargetTextarea:e=>"textarea"===n()(e).get(0).type?n()(e).get(0):n()(e).find("textarea").get(0),getRenderingTarget(e,t){let r
r="undefined"===typeof t?n()(e).parent().get(0):t(e)
n()(r).addClass("ic-RichContentEditor")
return r},_attrsToMirror(e){const t=["name"]
const r=a.a.reduce(e.attributes,(e,t)=>{e[t.name]=t.value
return e},{})
return a.a.pick(r,t)},createRCEProps(e,t){var r,i,n,s,a,c,l,d,_
const f=e.offsetWidth
const h=e.offsetHeight||400
h&&(t.tinyOptions=Object(o["a"])({height:h},t.tinyOptions||{}))
const b=ENV.LOCALE
const p=Object.keys(m["a"]).map(e=>({id:e,label:m["a"][e]})).sort((e,t)=>e.id===b?-1:t.id===b?1:e.label.localeCompare(t.label,b))
const g={enabled:ENV.use_rce_enhancements&&ENV.rce_auto_save,maxAge:Number.isNaN(ENV.rce_auto_save_max_age_ms)?36e5:ENV.rce_auto_save_max_age_ms}
return{defaultContent:e.value||t.defaultContent,editorOptions:u.bind(null,f,e.id,t,null),language:ENV.LOCALE,mirroredAttrs:this._attrsToMirror(e),onFocus:t.onFocus,onBlur:t.onBlur,textareaClassName:e.className,textareaId:e.id,trayProps:Object(k["a"])(),languages:p,liveRegion:()=>document.getElementById("flash_screenreader_holder"),ltiTools:null===(r=window.INST)||void 0===r?void 0:r.editorButtons,autosave:t.autosave||g,instRecordDisabled:ENV.RICH_CONTENT_INST_RECORD_TAB_DISABLED,maxInitRenderedRCEs:null!==(i=window.ENV)&&void 0!==i&&null!==(n=i.FEATURES)&&void 0!==n&&n.rce_limit_init_render_on_page?t.maxInitRenderedRCEs:-1,highContrastCSS:null===(s=window.ENV)||void 0===s?void 0:s.url_for_high_contrast_tinymce_editor_css,use_rce_pretty_html_editor:!!(null!==(a=window.ENV)&&void 0!==a&&null!==(c=a.FEATURES)&&void 0!==c&&c.rce_pretty_html_editor),use_rce_buttons_and_icons:!!(null!==(l=window.ENV)&&void 0!==l&&null!==(d=l.FEATURES)&&void 0!==d&&d.rce_buttons_and_icons),use_rce_a11y_checker_notifications:!!(null!==(_=window.ENV)&&void 0!==_&&_.use_rce_a11y_checker_notifications)}}}
t["a"]=v}}])

//# sourceMappingURL=23-c-c4175dddde.js.map