...
t.empty()
l.a.each(e.options,(e,i)=>{const a=l()("<div class='option minimal' style='cursor: pointer; padding: 2px 5px; overflow: hidden; white-space: nowrap;'>  <span tabindex='-1'>"+e+"</span></div>").appendTo(t)
function n(){a.parent().find("div.option").removeClass("ui-state-hover ui-state-active").addClass("minimal")}l.a.isFunction(i)?a.addClass("ui-state-default").bind({mouseenter(){n()
a.addClass("ui-state-hover").removeClass("minimal")},mouseleave:n,mousedown(e){e.preventDefault()
n()
a.addClass("ui-state-active").removeClass("minimal")},mouseup:n,click:i}):a.addClass("ui-state-disabled").bind({mousedown(e){e.preventDefault()}})})
const a=this.offset(),n=this.outerHeight()
this.outerWidth()
i.css({whiteSpace:"nowrap",position:"absolute",top:a.top+n,left:a.left+5,right:""}).hide().show()
i.offset().left+i.width()>l()(window).width()&&i.css({left:"",right:0})}return this}
l.a.fn.dropdownList.defaults={height:250,width:"auto"}
i("8JEM")
const d=ENV.MAX_MRU_LTI_TOOLS||5
var u={buttonConfig(e,t){const i=ENV.use_rce_enhancements
const a={title:e.name,classes:"widget btn instructure_external_tool_button"}
if(i){a.id=e.id
a.onAction=()=>{t.execCommand("instructureExternalButton"+e.id)
this.updateMRUList(e.id)
this.showHideButtons(t)}
a.description=e.description
a.favorite=e.favorite}else a.cmd="instructureExternalButton"+e.id
!i&&e.canvas_icon_class&&"string"===typeof e.canvas_icon_class?a.icon="hack-to-avoid-mce-prefix "+e.canvas_icon_class:a.image=e.icon_url
return a},clumpedButtonMapping:(e,t,i)=>e.reduce((e,a)=>{let n
n=a.canvas_icon_class?`<i class='${Object(c["a"])(a.canvas_icon_class)}' data-tool-id='${a.id}'></i>`:`<img src='${Object(c["a"])(a.icon_url)}' data-tool-id='${a.id}'/>`
n+="&nbsp;"+Object(c["a"])(a.name)
e[n]=function(){i(a,t)}
return e},{}),attachClumpedDropdown(e,t,i){e.dropdownList({options:t})
i.on("click",()=>{e.dropdownList("hide")})},showHideButtons(e){var t
const i=s.t("Apps")
const a=e.$(e.editorContainer.querySelector(`.tox-tbtn--select[aria-label="${i}"]`))
...
a.show()
n.hide()}else{a.attr("aria-hidden","true")
n.attr("aria-hidden","false")
a.hide()
n.show()}},updateMRUList(e){let t
try{var i
t=JSON.parse((null===(i=window.localStorage)||void 0===i?void 0:i.getItem("ltimru"))||"[]")}catch(e){console.log("Found bad LTI MRU data",e.message)}finally{Array.isArray(t)||(t=[])}try{if(!t.includes(e)){var a
t.unshift(e)
t.splice(d,t.length)
...
var h=i("dDTa")
var _=i("eodz")
const g=function(e,t){this.id=e.id
...
return l()("#"+this.id)}
this.createLink=function(e,t,i){Object(_["d"])(this.getEditor(),"create_link",{url:e,classes:t,selectedContent:this.selectedContent,dataAttributes:i,selectionDetails:this.selectionDetails})}}
var m=g
var p=i("SdaB")
i("ESjL")
i("aq8L")
class f{fetchYouTubeTitle(e,t){const i=ENV.JWT
const a=ENV.RICH_CONTENT_APP_HOST
const n=`//${a}/api/youtube_title?vid_id=${e}`
l.a.ajax({headers:{Authorization:"Bearer "+i},url:n}).success(i=>{i.id===e&&t(i.title)}).error(e=>{t(null,e)})}titleYouTubeText(e){const t=l.a.youTubeID(e.attr("href"))
this.fetchYouTubeTitle(t,(i,a)=>{if(a){console.error(`failed to get video title from youtube for "${t}":`,a.responseText)
const i=(+e.attr("data-ytt-failcnt")||0)+1
e.attr("data-ytt-failcnt",i)}else{e.text(i)
e.attr("data-preview-alt",i)}})}}const b=["instructure_scribd_file"]
const k=["instructure_scribd_file"]
const v=new WeakMap
function w(e){const t=e.closest("img").attr("src")
return"<img src='"+Object(c["a"])(t)+"'/>"}function y(e){e.nodeChanged()
return new m(e)}function x(e,t){let i=e.replace(/(auto_open|inline_disabled)/g,"")
t.find(".auto_show_inline_content").attr("checked")&&(i+=" auto_open")
t.find(".disable_inline_content").attr("checked")&&(i+=" inline_disabled")
return i}function S(e,t,i,a){const n=e.find("#instructure_link_prompt_form")
n.off("submit")
n.on("submit",(function(n){n.preventDefault()
n.stopPropagation()
e.data("editor")
const r=l()(this).find(".prompt").val()
const s=e.find(".inst-link-preview-alt input").val()
const o=x(i.call(),e)
const c={"preview-alt":s}
e.dialog("close")
t.createLink(r,o,c)
a.call()}))}function E(e){const t=y(e)
const i=t.getEditor()
var a=l()("#instructure_link_prompt")
let n=""
a.removeClass("for_inline_content").find(".disable_enhancement").hide().end().find(".auto_show").hide().end().find(".insert_button").text("Insert Link").end().find(".disable_inline_content").attr("checked",false).end().find(".auto_show_inline_content").attr("checked",false)
if(0==a.length){a=l()(document.createElement("div"))
Object(p["b"])("BookmarkService",(function(e){const t=a.data("editor")
const i=l()("<div style='text-align: left; margin-left: 20px;'/>")
let r,s
for(const a in e){r=e[a].user_service
if(r){s=l()("<a href='#' class='bookmark_service no-hover'/>")
...
l()("#instructure_link_prompt").dialog("close")
Object(p["a"])(l()(this).data("service").service,e=>{l()("#instructure_link_prompt").dialog("close")
Object(_["d"])(t,"create_link",{title:e.title,url:e.url,classes:n})})}))
i.append(s)
i.append("&nbsp;&nbsp;")}}a.find("#instructure_link_prompt_form").after(i)}))
a.append("<p><em>This will make the selected text a link, or insert a new link if nothing is selected.</em></p> <label for='instructure_link_prompt_form_input'>Paste or type a url or wiki page in the box below:</label><form id='instructure_link_prompt_form' class='form-inline'><input type='text' id='instructure_link_prompt_form_input' class='prompt' class='btn' value='http://'/> <button type='submit' class='insert_button btn'>Insert Link</button></form>").append("<div class='actions'></div><div class='clear'></div>").append('<div class="inst-link-preview-alt" style="display: none;"><label>Alt text for inline preview: <input type="text" style="display: block;" /></label></div>').append("<div class='disable_enhancement' style='display: none;'><input type='checkbox' class='disable_inline_content' id='disable_inline_content'/><label for='disable_inline_content'> Disable inline previews for this link</label></div>").append("<div class='auto_show' style='display: none;'><input type='checkbox' class='auto_show_inline_content' id='auto_show_inline_content'/><label for='auto_show_inline_content'> Auto-open the inline preview for this link</label></div>")
a.find(".disable_inline_content").change((function(){l()(this).attr("checked")&&a.find(".auto_show_inline_content").attr("checked",false)
a.find(".auto_show").showIf(!l()(this).attr("checked")&&a.hasClass("for_inline_content_can_auto_show"))}))
a.find(".actions").delegate(".embed_image_link","click",e=>{const t=a.data("editor")
const i=l()(e.target)
e.preventDefault()
Object(_["d"])(t,"insert_code",w(i))
a.dialog("close")})
a.find(".actions").delegate(".embed_youtube_link","click",e=>{e.preventDefault()
a.find("#instructure_link_prompt_form").triggerHandler("submit")})
a.find("#instructure_link_prompt_form .prompt").bind("change keyup",(function(){const e=a.find(".inst-link-preview-alt")
e.hide()
l()("#instructure_link_prompt .actions").empty()
const t=l()(this).val()
const i=a.data("original_data")
if(i&&t==i.url){a.toggleClass("for_inline_content",i.for_inline_content).toggleClass("for_inline_content_can_auto_show",i.for_inline_content_can_auto_show).find(".disable_enhancement").showIf(i.for_inline_content).end().find(".auto_show").showIf(i.for_inline_content_can_auto_show)
n=i.prior_classes}else{a.removeClass("for_inline_content").removeClass("for_inline_content_can_auto_show")
const e=new RegExp("("+b.join("|")+")","g")
n=n.replace(e,"")}let r=!a.hasClass("for_inline_content")
const s=!a.hasClass("for_inline_content_can_auto_show")
if(t.match(/\.(gif|png|jpg|jpeg)$/)){var o=l()(document.createElement("div"))
o.css("textAlign","center")
...
o.append(c)
l()("#instructure_link_prompt .actions").append(o)}else if(t.match(INST.youTubeRegEx)){e.show()
const i=l.a.youTubeID(t)
o=l()(document.createElement("div"))
o.css("textAlign","center")
!a.find(".disable_inline_content").attr("checked")&&a.hasClass("for_inline_content_can_auto_show")&&a.find(".auto_show").show()
r=false
a.find(".disable_enhancement").show()
c=l()(document.createElement("img"))
...
o.append(c)
l()("#instructure_link_prompt .actions").append(o)}if(r){a.find(".disable_enhancement").hide()
a.find(".disable_inline_content").attr("checked",false)}if(s){a.find(".auto_show").hide()
a.find(".auto_show_inline_content").attr("checked",false)}}))
a.attr("id","instructure_link_prompt")
l()("body").append(a)}const r=function(){return n}
const s=function(){T(e,true)}
S(a,t,r,s)
a.data("editor",i)
a.data("original_data",null)
let o=e.selection.getNode()
while("A"!=o.nodeName&&"BODY"!=o.nodeName&&o.parentNode)o=o.parentNode
const c="A"==o.nodeName?l()(o):null
if(c){a.find(".prompt").val(c.attr("href")).change()
a.find(".inst-link-preview-alt input").val(c.data("preview-alt"))
n=(c.attr("class")||"").replace(/youtube_link_to_box/,"")
var d=new RegExp("("+b.join("|")+")");(c.attr("class")||"").match(d)&&a.addClass("for_inline_content").find(".disable_enhancement").show()
d=new RegExp("("+k.join("|")+")");(c.attr("class")||"").match(d)&&a.addClass("for_inline_content_can_auto_show").find(".auto_show").show()
a.data("original_data",{url:c.attr("href"),for_inline_content:a.hasClass("for_inline_content"),for_inline_content_can_auto_show:a.hasClass("for_inline_content_can_auto_show"),prior_classes:n,preview_alt:c.data("preview-alt")})
a.find(".disable_inline_content").attr("checked",c.hasClass("inline_disabled")).triggerHandler("change")
a.find(".auto_show_inline_content").attr("checked",c.hasClass("auto_open")).triggerHandler("change")
a.find(".insert_button").text("Update Link")}else a.find(".prompt").val("").change()
a.dialog({width:425,height:"auto",title:"Link to Website URL",open(){l()(this).find(".prompt").focus().select()}})}function T(e,t){T.counter=T.counter||0
true==t&&0!=T.counter?T.counter=(T.counter+1)%5:l()(e.getBody()).find("a").each((function(){const e=new f
const t=l()(this)
...
t.text()===t.attr("href")&&i<1&&e.titleYouTubeText(t)}}))}function C(e){if(v.get(e)||void 0===e.on)return
e.on("PreProcess",(function(e){l()(e.node).find("a.youtube_link_to_box").removeClass("youtube_link_to_box")
l()(e.node).find("img.iframe_placeholder").each((function(){const e=l()(this)
const t=l()("<iframe/>")
const i=e.attr("height")||e.css("height")
const a=e.hasClass("fullWidth")?"100%":e.attr("width")||e.css("width")
e.attr("width",a)
e.css("width",a)
t.attr("src",e.attr("rel"))
t.attr("style",e.attr("_iframe_style"))
if(!t[0].style.height.length){t.attr("height",i)
t.css("height",i)}if(!t[0].style.width.length){t.attr("width",a)
t.css("width",a)}l()(this).after(t)
l()(this).remove()}))}))
e.on("change",()=>{T(e)})
e.on("SetContent",()=>{T(e,"contentJustSet")})
v.set(e,true)}var B={buttonToImg:w,prepEditorForDialog:y,buildLinkClasses:x,bindLinkSubmit:S,renderDialog:E,updateLinks:T,initEditor:C}
i("q1tI")
var A=i("i8i4")
var L=i.n(A)
const N={get more_external_tools(){return Object(c["a"])(s.t("more_external_tools","More External Tools"))}}
const P={init(e,t,n){B.initEditor(e)
if(!n||!n.editorButtons||!n.editorButtons.length)return
let r={open:(...e)=>setTimeout(()=>r.open(...e),50)}
Promise.all([i.e(1),i.e(3),i.e(4),i.e(6),i.e(16),i.e(4005)]).then(i.bind(null,"PrO8")).then(({default:t})=>{const i=document.createElement("div")
document.body.appendChild(i)
L.a.render(Object(a["a"])(t,{win:window,editor:e,contextAssetString:ENV.context_asset_string,iframeAllowances:Object(h["a"])(),resourceSelectionUrl:l()("#context_external_tool_resource_selection_url").attr("href"),deepLinkingOrigin:ENV.DEEP_LINKING_POST_MESSAGE_ORIGIN}),i,(function(){r=this}))})
const s=[]
const o=[]
for(let t=0;n.editorButtons&&t<n.editorButtons.length;t++){const i=n.editorButtons[t]
const a=()=>r.open(i)
if(ENV.use_rce_enhancements){o.push(u.buttonConfig(i,e))
e.addCommand("instructureExternalButton"+i.id,a)}else if(n.editorButtons.length>n.maxVisibleEditorButtons&&t>=n.maxVisibleEditorButtons-1)s.push(i)
else{e.addCommand("instructureExternalButton"+i.id,a)
e.addButton("instructure_external_button_"+i.id,u.buttonConfig(i,e))}}if(o.length&&ENV.use_rce_enhancements){j(e,o)
F(e,o)
R(e,o)
D(e,o)}if(s.length){const t=function(){const t=u.clumpedButtonMapping(s,e,e=>r.open(e))
u.attachClumpedDropdown(l()("#"+this._id),t,e)}
ENV.use_rce_enhancements?e.ui.registry.addButton("instructure_external_button_clump",{title:N.more_external_tools,image:"/images/downtick.png",onAction:t}):e.addButton("instructure_external_button_clump",{title:N.more_external_tools,image:"/images/downtick.png",onkeyup(e){if(32===e.keyCode||13===e.keyCode){e.stopPropagation()
t.call(this)}},onclick:t})}}}
function z(e,t){if(!t.iconSVG&&t.image){const e=document.createElement("svg")
...
t.icon="lti_tool_"+t.id}t.iconSVG&&e.ui.registry.addIcon(t.icon,t.iconSVG)}function D(e,t){t.length&&e.ui.registry.addNestedMenuItem("lti_tools_menuitem",{text:s.t("Apps"),icon:"lti",getSubmenuItems:()=>I(e,t)})}function j(e,t){const i=s.t("Apps")
e.ui.registry.addButton("lti_tool_dropdown",{onAction:()=>{const e=new CustomEvent("tinyRCE/onExternalTools",{detail:{ltiButtons:t}})
document.dispatchEvent(e)},icon:"lti",tooltip:i,onSetup(t){u.showHideButtons(e)}})}function F(e,t){t.forEach(t=>{if(!t.favorite)return
z(e,t)
e.ui.registry.addButton("instructure_external_button_"+t.id,{onAction:t.onAction,tooltip:t.title,icon:t.icon,title:t.title})})}function R(e,t){const i=s.t("Apps")
e.ui.registry.addMenuButton("lti_mru_button",{tooltip:i,icon:"lti",fetch(i){i(I(e,t))},onSetup(t){u.showHideButtons(e)}})}function I(e,t){const i=[]
try{const a=JSON.parse(window.localStorage.getItem("ltimru"))
if(a&&Array.isArray(a)&&a.length){const n=t.filter(e=>a.includes(e.id))
n.forEach(t=>{z(e,t)
t.menuItem||(t.menuItem={type:"menuitem",text:t.title,icon:t.icon,onAction:t.onAction})
i.push(t.menuItem)})
i.sort((e,t)=>e.text.localeCompare(t.text))}}catch(e){console.log("Failed building mru menu",e.message)}finally{i.push({type:"menuitem",text:s.t("View All"),onAction:()=>{const e=new CustomEvent("tinyRCE/onExternalTools",{detail:{ltiButtons:t}})
document.dispatchEvent(e)}})}return i}var V=P
var q=i("ik22")
function O(e={}){const t=["equationCB","linksCB","imagePickerCB","equellaCB","externalToolCB","recordCB"]
t.forEach(t=>{void 0===e[t]&&(e[t]=function(){})})
document.addEventListener("tinyRCE/initEquation",({detail:t})=>{Promise.all([i.e(7),i.e(4048)]).then(i.bind(null,"dIBj")).then(({default:i})=>{const a=new i(t.ed)
e.equationCB(a)})})
document.addEventListener("tinyRCE/initLinks",({detail:t})=>{B.renderDialog(t.ed)
e.linksCB()})
document.addEventListener("tinyRCE/initImagePicker",t=>{Promise.all([i.e(1),i.e(7),i.e(8),i.e(9),i.e(25),i.e(82),i.e(76),i.e(87),i.e(4006)]).then(i.bind(null,"FfTR")).then(({default:i})=>{const a=new i(t.detail.ed,t.detail.selectedNode)
e.imagePickerCB(a)})})
document.addEventListener("tinyRCE/initEquella",t=>{i.e(4124).then(i.bind(null,"IOhY")).then(({default:i})=>{i(t.detail.ed)
e.equellaCB()})})
document.addEventListener("tinyRCE/initExternalTools",t=>{V.init(t.detail.ed,t.detail.url,q["a"])
e.externalToolCB()})
document.addEventListener("tinyRCE/initRecord",t=>{Promise.all([i.e(44),i.e(4125)]).then(i.bind(null,"lUrZ")).then(({default:i})=>{i.insertEditor(t.detail.ed)
e.recordCB()})})}},JiFB:function(e,t,i){"use strict"
i.d(t,"a",(function(){return s}))
var a=i("VTBJ")
var n=i("uYtQ")
var r=i("ErZx")
class s{constructor(e,t,i,a){this.formatBtnGroup="bold italic underline forecolor backcolor removeformat alignleft aligncenter alignright"
...
return Object(a["a"])(Object(a["a"])({},r["a"]),{},{body_class:null!==(e=window.ENV.FEATURES)&&void 0!==e&&e.canvas_k6_theme||window.ENV.K5_SUBJECT_COURSE||window.ENV.K5_HOMEROOM_COURSE?"elementary-theme":"default-theme",selector:"#"+this.idAttribute,[!this.new_rce&&"toolbar"]:this.toolbar(),[!this.new_rce&&"theme"]:"modern",[!this.new_rce&&"skin"]:false,directionality:Object(n["b"])(),plugins:this.new_rce?"instructure_equation":"autolink,media,paste,table,lists,textcolor,link,directionality,a11y_checker,wordcount,instructure_image,instructure_links,instructure_equation,instructure_external_tools,instructure_record",content_css:window.ENV.url_to_what_gets_loaded_inside_the_tinymce_editor_css,menubar:!this.new_rce||void 0,init_instance_callback:e=>{$("#tinymce-parent-of-"+e.id).css("visibility","visible")},show_media_upload:!!INST.kalturaSettings&&!INST.kalturaSettings.hide_rte_button})}external_buttons(){let e=""
...
return e}buildInstructureButtons(){let e=" instructure_image instructure_equation"+(this.new_rce?" lti_tool_dropdown":"")
...
a=`${this.positionBtnGroup} ${t}`
n=this.fontBtnGroup}else if(this.viewportWidth<1200){i=`${this.formatBtnGroup} ${this.positionBtnGroup}`
a=`${t} ${this.fontBtnGroup}`}else i=`${this.formatBtnGroup} ${this.positionBtnGroup} ${t} ${this.fontBtnGroup}`
return this.new_rce?[i,a,n]:[i,a,n].map(e=>e.split(" ").join(","))}toolbar(){const e=this.buildInstructureButtons()
return this.balanceButtons(e)}}},SdaB:function(e,t,i){"use strict"
...
i("jQeR")
i("0sPK")
var r=a["default"].scoped("findLinkForService")
var s=i("ouhR")
var o=i.n(s)
var l=i("gI0r")
var c=i("JOjB")
...
i("Dhso")
i("ESjL")
function d(e,t,i){o.a.isArray(e)||(e=[e])
const a="/services?service_types="+e.join(",")
o.a.ajaxJSON(a,"GET",{},e=>{t&&t(e)},e=>{i&&i(e)})}let u
function h(e,t){let i=o()("#instructure_bookmark_search")
if(!i.length){i=o()("<div id='instructure_bookmark_search'/>")
i.append(`<form id='bookmark_search_form' style='margin-bottom: 5px;'><img src='/images/blank.png'/>&nbsp;&nbsp;<input type='text' class='query' style='width: 230px;'/><button class='btn search_button' type='submit'>${Object(l["a"])(r.t("buttons.search","Search"))}</button></form>`)
i.append("<div class='results' style='max-height: 200px; overflow: auto;'/>")
i.find("form").submit(t=>{t.preventDefault()
t.stopPropagation()
const a=new Date
if("diigo"==e&&u&&a-u<15e3){setTimeout(()=>{i.find("form").submit()},15e3-(a-u))
i.find(".results").empty().append(Object(l["a"])(r.t("status.diigo_search_throttling","Diigo limits users to one search every ten seconds.  Please wait...")))
return}i.find(".results").empty().append(Object(l["a"])(r.t("status.searching","Searching...")))
u=new Date
const n=i.find(".query").val()
const s=o.a.replaceTags(i.data("reference_url"),"query",n)
o.a.ajaxJSON(s,"GET",{},e=>{i.find(".results").empty()
e.length||i.find(".results").append(Object(l["a"])(r.t("no_results_found","No Results Found")))
...
o()("<div class='bookmark'/>").appendTo(i.find(".results")).append(o()('<a class="bookmark_link" style="font-weight: bold;"/>').attr({href:e[t].url,title:e[t].title}).text(e[t].short_title)).append(o()("<div style='margin: 5px 10px; font-size: 0.8em;'/>").text(e[t].description||r.t("no_description","No description")))}},()=>{i.find(".results").empty().append(Object(l["a"])(r.t("errors.search_failed","Search failed, please try again.")))})})
i.delegate(".bookmark_link","click",(function(e){e.preventDefault()
const a=o()(this).attr("href")
const n=o()(this).attr("title")||o()(this).text()
i.dialog("close")
t({url:a,title:n})}))}i.find(".search_button").text("delicious"==e?r.t("buttons.search_by_tag","Search by Tag"):r.t("buttons.search","Search"))
i.find("form img").attr("src",`/images/${e}_small_icon.png`)
let a="/search/bookmarks?q=%7B%7B+query+%7D%7D&service_type=%7B%7B+service_type+%7D%7D"
a=o.a.replaceTags(a,"service_type",e)
i.data("reference_url",a)
i.find(".results").empty().end().find(".query").val("")
i.dialog({title:r.t("titles.bookmark_search","Bookmark Search: %{service_name}",{service_name:o.a.titleize(e)}),open(){i.find("input:visible:first").focus().select()},width:400})}},eVns:function(e,t,i){"use strict"
i.d(t,"a",(function(){return o}))
var a=i("ODXe")
var n=i("BrAc")
function r(e){let t=e
let i=null
return e=>{null===i&&(i=n["a"].post("/api/v1/jwts/refresh",{jwt:t}).then(e=>{i=null
t=e.data.token
return t}))
"function"===typeof e&&i.then(e)
return i}}var s=i("s9Pr")
function o(){if(!ENV.context_asset_string)return null
let e=Object(s["a"])(ENV.context_asset_string,false),t=Object(a["a"])(e,2),i=t[0],n=t[1]
const o=ENV.current_user_id
const l={contextType:i,contextId:n,userId:o}
const c=!ENV.use_rce_enhancements||ENV.RICH_CONTENT_CAN_UPLOAD_FILES
if(!c||"account"===i){n=o
i="user"}return{canUploadFiles:ENV.RICH_CONTENT_CAN_UPLOAD_FILES,containingContext:l,contextType:i,contextId:n,filesTabDisabled:ENV.RICH_CONTENT_FILES_TAB_DISABLED,host:ENV.RICH_CONTENT_APP_HOST,jwt:ENV.JWT,refreshToken:r(ENV.JWT),themeUrl:ENV.active_brand_config_json_url}}}}])

//# sourceMappingURL=21-c-7ea1280f59.js.map