(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[168],{EwH5:function(e,t,r){"use strict"
var i=r("ko/W")
t["a"]=function(e){e&&i["a"].unregisterAllTrackers()
i["a"].isRunning()||i["a"].start()
if(i["a"].isDirty())return i["a"].deliver()}},JOjB:function(e,t,r){"use strict"
var i=r("ouhR")
var s=r.n(i)
var o=r("HGxv")
var n=r("8WeW")
...
return e},{})}},hLjT:function(e,t){e.exports=e=>e.id.replace(/^question_/,"")},hpsT:function(e,t,r){"use strict"
...
var h=r.n(d)
var g=r("hpsT")
const c={Accept:"application/json; charset=UTF-8","Content-Type":"application/json; charset=UTF-8"}
class x{constructor(e={}){this.options=Object(s["extend"])({},x.options,e)
...
const s=Object(d["ajax"])({url:r.deliveryUrl,type:"POST",global:false,headers:c,data:JSON.stringify({quiz_submission_events:i.toJSON()}),error:r.errorHandler})
s.then(()=>e.discard(i),()=>i.markPendingDelivery())
const o=()=>Object(g["a"])(t,s)
s.then(o,o)
t.push(s)
return s}stop(e=false){const t=this._state
...
t.trackers=[]
return Object(d["when"])()}_startDeliveryAgent(){return this._state.deliveryAgent=setInterval(this.deliver.bind(this),this.options.autoDeliveryFrequency)}_enqueue(e,t){if(e.type===i.EVT_PAGE_FOCUSED&&this._state.lastEventType!==i.EVT_PAGE_BLURRED)return false
...
this.uid=`${this.eventType}_${Object(s["uniqueId"])()}`}install(e){throw new Error("Not implemented!")}getEventType(){return this.eventType}getDeliveryPriority(){return this.priority}getOption(e){return this._options[e]}uninstall(){if(this._bindings){this._bindings.forEach(e=>h()(e.selector).off(e.eventName))
return this._bindings=null}}bind(e,t,r,i={}){this._bindings||(this._bindings=[])
...
h()(e).on(`${t}.${this.eventType}`,r)}}class v extends E{install(e){return this.bind(window,"focus",()=>e(),{throttle:this.getOption("frequency")})}}v.prototype.eventType=i.EVT_PAGE_FOCUSED
v.prototype.options={frequency:5e3}
class f extends E{install(e){return this.bind(window,"blur",()=>{setTimeout(()=>{"IFRAME"!==document.activeElement.tagName&&e()})},{throttle:this.getOption("frequency")})}}f.prototype.eventType=i.EVT_PAGE_BLURRED
f.prototype.options={frequency:5e3}
const T=h()(window)
function b(e){const t=h()(e)
const r=T.scrollTop()
const i=r+T.height()
const s=t.offset().top
const o=s+t.height()
return r<s&&i>o}h.a.extend(h.a.expr[":"],{in_viewport:b})
var w=r("hLjT")
var y=r.n(w)
...
return e(t)}},{throttle:this.getOption("frequency")})}identifyVisibleQuestions(){return h()(".question[id]:visible").filter(":in_viewport").toArray().map(y.a)}}O.prototype.eventType=i.EVT_QUESTION_VIEWED
...
const s=y()(r[0])
_.a.log(`Question ${s} ${i?"is now flagged":"is no longer flagged"}.`)
...
const A=[v,f,O,S,q]
const R=new x
A.forEach(e=>R.registerTracker(e))
...
//# sourceMappingURL=168-c-5d42c2443d.js.map