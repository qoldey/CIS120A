...
public class Number {
    ...
    // private Map<Character, Integer> hexatoDec; // for hexadecimal to decimal
    // conversion
    // private Map<Integer, Character> dectoHex; // for decimal to hexadecimal
    ...
    public String toDecimal() {
        ...
        for (int i = tempVal.length() - 1; i >= 0; i--) {
            ...
            // if (this.base == 16 && hexatoDec.containsKey(tempVal.charAt(i))) {
    ...
    public String toBase(int targetBase) {
        ...
        // if (targetBase == 16 && dectoHex.containsKey(tempValue)) {
