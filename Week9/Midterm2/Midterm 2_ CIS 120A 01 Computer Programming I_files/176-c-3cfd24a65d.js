(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[176],{"3l1C":function(t,e,s){"use strict"
s.d(e,"a",(function(){return z}))
var i=s("VTBJ")
var n=s("ouhR")
var o=s.n(n)
var u=s("Y/W1")
...
return this.initAllDates()}initId(){this.id=this.isQuizzesNext()?"assignment_"+this.get("id"):this.get("id")}initAssignment(){this.attributes.assignment&&this.set("assignment",new p["a"](this.attributes.assignment))
...
let e=""
t&&t>0&&!this.isUngradedSurvey()&&(e=Number.isInteger(t)?g.t("assignment_points_possible","pt",{count:t}):g.t("%{points} pts",{points:g.n(t)}))
return this.set("possible_points_label",e)}isQuizzesNext(){return"quizzes.next"===this.get("quiz_type")}isUngradedSurvey(){return"survey"===this.get("quiz_type")}publish_url(){if(this.isQuizzesNext())return this.get("base_url")+"/publish/quiz"
return this.get("base_url")+"/publish"}unpublish_url(){if(this.isQuizzesNext())return this.get("base_url")+"/unpublish/quiz"
return this.get("base_url")+"/unpublish"}url(){var t,e
if(this.isQuizzesNext()&&null!==(t=ENV.PERMISSIONS)&&void 0!==t&&t.manage&&null!==(e=ENV.FLAGS)&&void 0!==e&&e.new_quizzes_modules_support)return this.edit_url()
return this.build_url()}build_url(){return`${this.get("base_url")}/${this.get("id")}`}edit_url(){const t=this.isQuizzesNext()?"?quiz_lti":""
return`${this.get("base_url")}/${this.get("id")}/edit${t}`}deletion_url(){if(this.isQuizzesNext())return`${this.get("base_url")}/${this.get("id")}`
return this.get("url")}initAllDates(){let t
...
return this.set("lock_at",t)}importantDates(t){if(!(arguments.length>0))return this.get("important_dates")
return this.set("important_dates",t)}isDuplicating(){return"duplicating"===this.get("workflow_state")}isMigrating(){return"migrating"===this.get("workflow_state")}name(t){if(!(arguments.length>0))return this.get("title")
return this.set("title",t)}htmlUrl(){return this.get("url")}buildUrl(){return this.get("build_url")}destroy(t){const e=Object(i["a"])({url:this.get("deletion_url")},t)
r.a.Model.prototype.destroy.call(this,e)}defaultDates(){return new d["a"]({due_at:this.get("due_at"),unlock_at:this.get("unlock_at"),lock_at:this.get("lock_at")})}duplicate(t){const e=this.get("course_id")
const s=this.get("id")
return o.a.ajaxJSON(`/api/v1/courses/${e}/assignments/${s}/duplicate`,"POST",{quizzes:[s],result_type:"Quiz"},t)}duplicate_failed(t){const e=this.get("course_id")
const s=this.get("id")
const i=this.get("original_course_id")
const n=this.get("original_assignment_id")
let u="?target_assignment_id="+s
i!==e&&(u+="&target_course_id="+e)
o.a.ajaxJSON(`/api/v1/courses/${i}/assignments/${n}/duplicate${u}`,"POST",{},t)}retry_migration(t){const e=this.get("course_id")
const s=this.get("original_quiz_id")
o.a.ajaxJSON(`/api/v1/courses/${e}/content_exports?export_type=quizzes2&quiz_id=${s}&include[]=migrated_quiz`,"POST",{},t)}pollUntilFinishedLoading(t){this.isDuplicating()&&this.pollUntilFinished(t,this.isDuplicating)
this.isMigrating()&&this.pollUntilFinished(t,this.isMigrating)}pollUntilFinished(t,e){const s=this.get("course_id")
const i=this.get("id")
const n=new m["a"](t,5*t,t=>{this.fetch({url:`/api/v1/courses/${s}/assignments/${i}?result_type=Quiz`}).always(()=>{t()
if(!e())return n.stop()})})
n.start()}multipleDueDates(){const t=this.get("all_dates")
return t&&t.length>1}nonBaseDates(){const t=this.get("all_dates")
if(!t)return false
const e=a.a.filter(t,t=>t&&!t.get("base"))
return e.length>0}allDates(){const t=this.get("all_dates")
const e=t&&t.models||[]
return a.a.map(e,t=>t.toJSON())}singleSectionDueDate(){return f(a.a.find(this.allDates(),"dueAt"),t=>t.dueAt.toISOString())||this.dueAt()}isOnlyVisibleToOverrides(t){if(!(arguments.length>0))return this.get("only_visible_to_overrides")||false
return this.set("only_visible_to_overrides",t)}postToSIS(t){if(!(arguments.length>0))return this.get("post_to_sis")
return this.set("post_to_sis",t)}postToSISName(){return ENV.SIS_NAME}sisIntegrationSettingsEnabled(){return ENV.SIS_INTEGRATION_SETTINGS_ENABLED}maxNameLength(){return ENV.MAX_NAME_LENGTH}maxNameLengthRequiredForAccount(){return ENV.MAX_NAME_LENGTH_REQUIRED_FOR_ACCOUNT}dueDateRequiredForAccount(){return ENV.DUE_DATE_REQUIRED_FOR_ACCOUNT}toView(){const t=["htmlUrl","buildUrl","multipleDueDates","nonBaseDates","allDates","dueAt","lockAt","unlockAt","singleSectionDueDate","importantDates"]
const e={id:this.get("id")}
for(const s of t)e[s]=this[s]()
return e}postToSISEnabled(){return ENV.FLAGS&&ENV.FLAGS.post_to_sis_enabled}objectType(){return"Quiz"}}z.prototype.resourceName="quizzes"
...
var a=s.n(u)
s("ESjL")
const l={async loadBindings(){await Promise.all([s.e(5),s.e(10),s.e(14),s.e(15),s.e(16),s.e(21),s.e(22),s.e(25),s.e(28),s.e(40),s.e(52),s.e(50),s.e(51),s.e(66),s.e(71),s.e(75),s.e(82),s.e(114),s.e(4112)]).then(s.bind(null,"SG4G"))},async ready(){await this.loadBindings()
...
return t},async replaceLoadingDialog(t,e){await this.loadBindings()
a()("body").append(t)
e.dialog("close")
e.remove()
l.ready()},async createRubricDialog(t,e){const s=a()("#rubrics.rubric_dialog")
if(s.length)await l.ready()
else{const s=l.buildLoadingDialog()
if(void 0===e||null===e){const e=await a.a.get(t)
await l.replaceLoadingDialog(e,s)}else await l.replaceLoadingDialog(e,s)}}}
a()(document).ready((function(){a()(".show_rubric_link").click((function(t){t.preventDefault()
const e=a()(this).attr("rel")
l.createRubricDialog(e)}))}))}}])

//# sourceMappingURL=176-c-3cfd24a65d.js.map