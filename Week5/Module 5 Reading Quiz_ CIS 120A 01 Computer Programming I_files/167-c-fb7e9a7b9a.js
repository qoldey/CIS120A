(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[167],{cllE:function(e,n,s){"use strict"
var t=s("3O+N")
var a=s.n(t)
s("BGrI")
var o=a.a.default
var i=o.template,r=o.templates=o.templates||{}
var _="/work/canvas-deploy/generated/ui/shared/forms/jst/EmptyDialogFormWrapper"
r[_]=i((function(e,n,s,t,a){this.compilerInfo=[4,">= 1.0.0"]
s=this.merge(s,e.helpers)
a=a||{}
return'<div class="outlet"></div>\n'}))
n["a"]=r[_]},dbrX:function(e,n,s){"use strict"
var t=s("ODXe")
var a=s("uYtQ")
var o=s("QLaP")
var i=s.n(o)
const r={}
const _={getCssVariant(){const e=window.ENV.use_responsive_layout?"responsive_layout":"new_styles"
const n=window.ENV.use_high_contrast?"high_contrast":"normal_contrast"
const s=Object(a["c"])()?"_rtl":""
return`${e}_${n}${s}`},getHandlebarsIndex:()=>window.BRANDABLE_CSS_HANDLEBARS_INDEX||[[],{}],urlFor(e,{combinedChecksum:n,includesNoVariables:s}){const t=s?"no_variables":_.getCssVariant()
return[window.ENV.ASSET_HOST||"","dist","brandable_css",t,`${e}-${n}.css`].join("/")},loadStylesheet(e,n){if(e in r)return
const s=document.createElement("link")
s.rel="stylesheet"
s.href=_.urlFor(e,n)
s.setAttribute("data-loaded-by-brandableCss",true)
document.head.appendChild(s)},loadStylesheetForJST({bundle:e,id:n}){const s=_.getHandlebarsIndex(),a=Object(t["a"])(s,2),o=a[0],r=a[1]
i()(r.hasOwnProperty(n),`requested to load stylesheet for template "${e}" (${n}) but no mapping is available for it!`)
if(1===r[n].length)return _.loadStylesheet(e,{combinedChecksum:r[n][0],includesNoVariables:true})
{let s=r[n][o.indexOf(_.getCssVariant())]
"number"===typeof s&&(s=r[n][s])
return _.loadStylesheet(e,{combinedChecksum:s,includesNoVariables:false})}}}
n["a"]=_},pcEE:function(e,n,s){"use strict"
var t=s("HGxv")
var a=s("8WeW")
...
var u="/work/canvas-deploy/generated/ui/shared/message-students-dialog/jst/-messageStudentsWhoRecipientList"
l[u]=g((function(e,n,s,t,a){this.compilerInfo=[4,">= 1.0.0"]
s=this.merge(s,e.helpers)
a=a||{}
var o,i="",r="function",_=this.escapeExpression,c=this
function d(e,n){var t,a,o=""
o+='\n  <span class="label">\n    '
if(a=s.short_name)t=a.call(e,{hash:{},data:n})
else{a=e&&e.short_name
t=typeof a===r?a.call(e,{hash:{},data:n}):a}o+=_(t)+"\n  </span>\n"
return o}o=s.each.call(n,n&&n.recipients,{hash:{},inverse:c.noop,fn:c.program(1,d,a),data:a});(o||0===o)&&(i+=o)
i+="\n"
return i}))
p.registerPartial("ui/shared/message-students-dialog/jst/_messageStudentsWhoRecipientList.handlebars",l["/work/canvas-deploy/generated/ui/shared/message-students-dialog/jst/-messageStudentsWhoRecipientList"])
var m=l[u]
...
a=a||{}
var o,i,r,_="",c="function",d=this.escapeExpression,p=this,g=s.helperMissing
function l(e,n){var s,t=""
t+="\n      "+d((s=(s=(s=e&&e.recipientGroups,null==s||false===s?s:s[0]),null==s||false===s?s:s.name),typeof s===c?s.apply(e):s))+'\n      <input type="hidden" name="recipientGroupName" value="'+d((s=(s=(s=e&&e.recipientGroups,null==s||false===s?s:s[0]),null==s||false===s?s:s.name),typeof s===c?s.apply(e):s))+'" />\n    '
...
t=typeof a===c?a.call(e,{hash:{},data:n}):a}o+=d(t)+'">'
if(a=s.name)t=a.call(e,{hash:{},data:n})
else{a=e&&e.name
t=typeof a===c?a.call(e,{hash:{},data:n}):a}o+=d(t)+"</option>\n        "
return o}_+='<div class="message-students-dialog form-dialog-content">\n  <div class="message-recipients-group-container">\n    <label for="message-recipients-group">\n     '+d((i=s.t||n&&n.t,r={hash:{i18n_inferred_key:true},data:a},i?i.call(n,"recipients_a69b5e55","Recipients:",r):g.call(n,"t","recipients_a69b5e55","Recipients:",r)))+"\n    </label>\n\n    "
o=(i=s.ifEqual||n&&n.ifEqual,r={hash:{},inverse:p.program(3,u,a),fn:p.program(1,l,a),data:a},i?i.call(n,(o=n&&n.recipientGroups,null==o||false===o?o:o.length),1,r):g.call(n,"ifEqual",(o=n&&n.recipientGroups,null==o||false===o?o:o.length),1,r));(o||0===o)&&(_+=o)
_+='\n  </div>\n\n  <div id="message-recipients">\n    '
o=p.invokePartial(t["ui/shared/message-students-dialog/jst/_messageStudentsWhoRecipientList.handlebars"],"ui/shared/message-students-dialog/jst/_messageStudentsWhoRecipientList.handlebars",n,s,t,a);(o||0===o)&&(_+=o)
_+='\n  </div>\n\n  <textarea name=body></textarea>\n\n</div>\n<div class="form-controls">\n  <button class="btn dialog_closer btn-secondary" type="button"\n    data-text-while-loading=\''+d((i=s.t||n&&n.t,r={hash:{i18n_inferred_key:true},data:a},i?i.call(n,"sending_bf324366","Sending...",r):g.call(n,"t","sending_bf324366","Sending...",r)))+"'>\n    "+d((i=s.t||n&&n.t,r={hash:{i18n_inferred_key:true},data:a},i?i.call(n,"cancel_caeb1e68","Cancel",r):g.call(n,"t","cancel_caeb1e68","Cancel",r)))+'\n  </button>\n  <button class="btn btn-primary"\n    data-text-while-loading=\''+d((i=s.t||n&&n.t,r={hash:{i18n_inferred_key:true},data:a},i?i.call(n,"sending_bf324366","Sending...",r):g.call(n,"t","sending_bf324366","Sending...",r)))+"'\n    data-text-when-loaded='"+d((i=s.t||n&&n.t,r={hash:{i18n_inferred_key:true},data:a},i?i.call(n,"sent_f4ee89ec","Sent!",r):g.call(n,"t","sent_f4ee89ec","Sent!",r)))+"'>\n    "+d((i=s.t||n&&n.t,r={hash:{i18n_inferred_key:true},data:a},i?i.call(n,"send_message_6ccc90e8","Send Message",r):g.call(n,"t","send_message_6ccc90e8","Send Message",r)))+"\n  </button>\n\n</div>\n"
return _}))
f["a"].loadStylesheetForJST({id:"e2",bundle:"jst/messageStudentsDialog"})
var k=v[y]
var x=s("cllE")
var S=s("LvDl")
var M=s.n(S)
...
a={}
e.body&&r.a.trim(e.body.toString())||(a.body=[{message:n}])
...
return r.a.when.apply(r.a,s)}
e.prototype.validate=function(e,n){return(new G).validate(e,n)}
return e}()
var z=s("Y/W1")
var B=s.n(z)
s("VrN0")
var V=function(e,n){return function(){return e.apply(n,arguments)}},R=function(e,n){for(var s in n)C.call(n,s)&&(e[s]=n[s])
function t(){this.constructor=e}t.prototype=n.prototype
e.prototype=new t
e.__super__=n.prototype
return e},C={}.hasOwnProperty
n["a"]=function(e){R(n,e)
function n(){this.updateListOfRecipients=V(this.updateListOfRecipients,this)
this.getFormData=V(this.getFormData,this)
this._findRecipientGroupByName=V(this._findRecipientGroupByName,this)
this.validateBeforeSave=V(this.validateBeforeSave,this)
this.toJSON=V(this.toJSON,this)
...
n.prototype.events=B.a.extend({},_["a"].prototype.events,{"change [name=recipientGroupName]":"updateListOfRecipients","click .dialog_closer":"close",dialogclose:"close"})
...
return r.a.flashMessage(o.t("Message Sent!"))}
n.prototype.close=function(){n.__super__.close.apply(this,arguments)
this.hideErrors()
return this.remove()}
return n}(_["a"])},plYi:function(e,n,s){"use strict"
var t=s("HGxv")
n["a"]={strings(e,n){let s=t["default"].locale||"en-US"
const a={zh_Hant:"zh-Hant"}
s=a[s]||s
return e.localeCompare(n,s,{sensitivity:"variant",ignorePunctuation:false,numeric:true})},by(e){return(n,s)=>this.strings(e(n),e(s))},byKey(e){return this.by(n=>n[e])},byGet(e){return this.by(n=>n.get(e))}}}}])

//# sourceMappingURL=167-c-fb7e9a7b9a.js.map